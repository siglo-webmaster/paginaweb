...
class classviewProductos {
    ...
    function menuModule(){
        $return = "<h2 class='tituloModulo'>Productos</h2><div class='menuModule'><ul>".
                "<li><a href='index.php?action=loadModule&id_module=$this->id_modulos&opt=listarProductosActivos'>Listar Productos ACTIVOS</a></li>".
                "<li><a href='index.php?action=loadModule&id_module=$this->id_modulos&opt=listarProductosInactivos'>Listar Productos INACTIVOS</a></li>".
                "<li><a href='index.php?action=loadModule&id_module=$this->id_modulos&opt=listarTodosProductos'>Listar TODOS</a></li>".
    ...
    function getFormEditProducto($tipo_destacados,$data = false){
        ...
        $return = "<form action='index.php' method='post' enctype=\"multipart/form-data\">
                    ...
                    <input type='hidden' name='opt' value='saveProducto' />
                    <input type='hidden' name='sel' id='sel' value='".$sel."' >
                    <div class='formulario'>".
                    "<div class='titulo'><h2>Creaci&oacute;n / Edici&oacute;n de Productos</h2></div>".
                    "<p>".
                    "Nombre Producto: ".
                    ...
                    $tipos.
                    "</p>".
                    "<p><div id='seleccionProductos'></div></p>".
                    "<p>".
                    "Fecha Inicio: ".
    ...
    function saveProducto($data){
        return ($data)?"<div class='mensaje'><p>Producto Salvado</p></div>":"<div class='mensaje'><p>Error guardando Producto</p></div>";
    }
    function delProducto($data){
        return ($data)?"<div class='mensaje'><p>Producto Eliminado</p></div>":"<div class='mensaje'><p>Error eliminando Producto</p></div>";
    }
