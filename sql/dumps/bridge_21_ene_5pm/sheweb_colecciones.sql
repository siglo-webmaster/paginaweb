...
CREATE TABLE `colecciones` (
  `id_colecciones` int(11) NOT NULL AUTO_INCREMENT,
  `id_editoriales` int(11) NOT NULL,
  `nombre` varchar(128) NOT NULL,
  `estado` varchar(15) NOT NULL,
  PRIMARY KEY (`id_colecciones`,`id_editoriales`),
  KEY `editoriales_colecciones_fk` (`id_editoriales`),
  CONSTRAINT `editoriales_colecciones_fk` FOREIGN KEY (`id_editoriales`) REFERENCES `editoriales` (`id_editoriales`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2013-01-21 17:38:40
