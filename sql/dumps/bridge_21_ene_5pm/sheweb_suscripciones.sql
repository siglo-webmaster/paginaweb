...
CREATE TABLE `suscripciones` (
  ...
  KEY `periodos_suscripciones_fk` (`id_periodos`),
  KEY `titulos_suscripciones_fk` (`id_titulos`),
  CONSTRAINT `periodos_suscripciones_fk` FOREIGN KEY (`id_periodos`) REFERENCES `periodos` (`id_periodos`) ON DELETE NO ACTION ON UPDATE NO ACTION,
