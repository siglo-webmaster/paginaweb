...
CREATE TABLE `monedas` (
  ...
  `tasa_actual` decimal(10,2) NOT NULL,
...
INSERT INTO `monedas` VALUES (1,'PESO COLOMBIANO','COP',1.00,0,'activo'),(2,'EURO','EUR',2332.28,2,'activo'),(3,'DOLAR AMERICANO','USD',1763.85,2,'activo');
