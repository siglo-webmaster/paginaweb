...
CREATE TABLE `novedades` (
  ...
  KEY `titulos_novedades_fk` (`id_titulos`),
  CONSTRAINT `titulos_novedades_fk` FOREIGN KEY (`id_titulos`) REFERENCES `titulos` (`id_titulos`) ON DELETE NO ACTION ON UPDATE NO ACTION
