...
CREATE TABLE `ordenes_productos` (
  ...
  CONSTRAINT `proveedores_ordenes_productos_fk` FOREIGN KEY (`id_proveedores`) REFERENCES `proveedores` (`id_proveedores`) ON DELETE NO ACTION ON UPDATE NO ACTION,
