...
--
-- Table structure for table `tipo_negociacion`
--

DROP TABLE IF EXISTS `tipo_negociacion`;
...
--
-- Dumping data for table `tipo_negociacion`
--

LOCK TABLES `tipo_negociacion` WRITE;
/*!40000 ALTER TABLE `tipo_negociacion` DISABLE KEYS */;
/*!40000 ALTER TABLE `tipo_negociacion` ENABLE KEYS */;
UNLOCK TABLES;
