...
CREATE TABLE `departamentos` (
  ...
  KEY `fk_departamentos_paises1` (`paises_id_paises`),
  CONSTRAINT `fk_departamentos_paises1` FOREIGN KEY (`paises_id_paises`) REFERENCES `paises` (`id_paises`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `departamentos` VALUES (1,1,'BOGOTA D.C'),(2,1,'CUNDINAMARCA');
