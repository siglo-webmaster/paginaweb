...
CREATE TABLE `detalles_ordenes_transportadoras` (
  ...
  `id_terceros_proveedor` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id_detalles_ordenes_transportadoras`),
  ...
  KEY `fk_detalles_ordenes_transportadoras_terceros1` (`id_terceros_proveedor`),
  CONSTRAINT `fk_detalles_ordenes_transportadoras_terceros1` FOREIGN KEY (`id_terceros_proveedor`) REFERENCES `terceros` (`id_terceros`) ON DELETE CASCADE ON UPDATE CASCADE,
